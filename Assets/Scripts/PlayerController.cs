...
public class PlayerController : MonoBehaviour
{
    ...
    {
        Vector3 direction;
        if(this.gameObject.transform.position.z < -74f)
        {
        ...
        else
        {
            if(input.axis.y>0)
            {
                ...
                this.gameObject.transform.position = new Vector3(this.gameObject.transform.position.x, this.gameObject.transform.position.y, -74f);
            }
            else
            {
